...
public class GetTournamentsByOrganizerQueryHandler
    : IRequestHandler<GetTournamentsByOrganizerQuery, IEnumerable<TournamentDto>>
{
    private readonly ITournamentRepository _repository;

    public GetTournamentsByOrganizerQueryHandler(ITournamentRepository repository)
    {
        _repository = repository;
    }

    public async Task<IEnumerable<TournamentDto>> Handle(
        GetTournamentsByOrganizerQuery request,
    ...
    )
    {
        ...
        return tournaments
            .Where(t => t.OrganizerId == request.OrganizerId)
